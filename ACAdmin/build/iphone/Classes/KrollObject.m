 ...
 * Copyright (c) 2009-2011 by ACAdmin, Inc. All Rights Reserved.
...
//@interface ACAdminObject : NSObject
//@end

@interface ACAdminObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ACAdminObject class]])
		{
			for (NSString *key in [[(ACAdminObject*)o modules] allKeys])
			{
