...
// in simulator we redefine to format for ACAdmin Developer console
...
{\
	NSString * exceptionName = [@"org.acadmin." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.acadmin";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIACAdminNativeItemNone = -1, 
	UIACAdminNativeItemSpinner = -2,
	UIACAdminNativeItemProgressBar = -3,
	
	UIACAdminNativeItemSlider = -4,
	UIACAdminNativeItemSwitch = -5,
	UIACAdminNativeItemMultiButton = -6,
	UIACAdminNativeItemSegmented = -7,
	
	UIACAdminNativeItemTextView = -8,
	UIACAdminNativeItemTextField = -9,
	UIACAdminNativeItemSearchBar = -10,
	
	UIACAdminNativeItemPicker = -11,
	UIACAdminNativeItemDatePicker = -12,
	
	UIACAdminNativeItemInfoLight = -13,
	UIACAdminNativeItemInfoDark = -14,
	
	UIACAdminNativeItemDisclosure = -15,
	
	UIACAdminNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ACAdmin instances of
